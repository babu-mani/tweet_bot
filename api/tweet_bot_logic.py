...
# --- Configuration ---
# FONT_PATH is set relative to the script's location within the 'api' directory on Vercel.
FONT_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "font", "Roboto-Bold.ttf")
